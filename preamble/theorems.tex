...
% placing these imports below the theorem definitions leads to every theorem
% being referred as `theorem' in spite of the \crefname's.
\usepackage{hyperref}
...
\newenvironment{solution}[1][]
  ...
  \begin{oldproof}[\ifx&#1&Solution\else#1\fi]}
  {\end{oldproof}}
...
\newcommand*{\crefifdef}[2]{\refifdef{#1}{\cref}{#2}}
\newcommand*{\Crefifdef}[2]{\refifdef{#1}{\Cref}{#2}}
\makeatother
